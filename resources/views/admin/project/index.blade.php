...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="col-sm-3">
              <span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add project</a></span>
            <!-- Add New -->
    ...
    <div class="modal fade bd-example-modal-lg" id="addnew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <form  action="{{route('project.store')}}" method="POST">
          ...
          <div class="row">
            <div class="col-lg-12">
              <label class="control-label" style="position:relative; top:7px;">projectDec Description:</label>
            </div>
          </div>
          <div style="height:5px;"></div>
          <div class="row">
            <div class="col-lg-12">
              <textarea class="form-control" rows="2" name="projectDec" id="projectDec" placeholder="project Description"></textarea>
            </div>
          </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$row->id}}</td>
                  <td>{{$row->title}}</td>
                  <td>{!! $row->projectDec !!}</td>
                  <td><a class="btn btn-primary" href="{{route('project.edit',$row->id)}}" role="button">Edit</a></td>
                  <td>
                    <form action="{{route('project.destroy',$row->id)}}" method="POST" onsubmit="return confirm('Are you sure ?')">
                     @csrf
                     @method('delete')
