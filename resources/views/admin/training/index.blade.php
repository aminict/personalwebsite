    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
		  ...
		  <div class="col-sm-3">
              <span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add training</a></span>
            <!-- Add New -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Add training</h4></center>
                </div>
          ...
          @if (Session ::has('success'))
            ...
            @if (Session ::has('danger'))
             ...
             @endif
					...
					<div class="row">
						<div class="col-lg-12">
							<label class="control-label" style="position:relative; top:7px;">trainingDec Description:</label>
						</div>
					</div>
					<div style="height:5px;"></div>
					<div class="row">
						<div class="col-lg-12">
							<textarea class="form-control" rows="2" name="trainingDec" id="trainingDec" placeholder="trainingDec Description"></textarea>
						</div>
					</div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$row->id}}</td>
                  <td>{{$row->title}}</td>
                  <td>{!! $row->trainingDec !!}</td>
                  <td><a class="btn btn-primary" href="{{route('training.edit',$row->id)}}" role="button">Edit</a></td>
                  <td>
                  	<form action="{{route('training.destroy',$row->id)}}" method="POST" onsubmit="return confirm('Are you sure ?')">
                     @csrf
                     @method('delete')
