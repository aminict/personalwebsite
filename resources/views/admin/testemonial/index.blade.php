  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            <h1>Testemonial Setup</h1>
          </div>
		  <div class="col-sm-3">
              <span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Testemonial</a></span>
            <!-- Add New -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Add Testemonial</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
				<form  action="{{route('testemonial.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
           ...
           @if (Session ::has('success'))
            ...
            @if (Session ::has('danger'))
             ...
             @endif
					...
					<div class="row">
						<div class="col-lg-12">
							<textarea class="form-control" rows="2" name="message" id="message" placeholder="Message Body"></textarea>
						</div>
					</div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$row->publish}}</td>
                  <td><a class="btn btn-primary" href="{{route('testemonial.edit',$row->id)}}" role="button">Edit</a></td>
                  <td>
                  	<form action="{{route('testemonial.destroy',$row->id)}}" method="POST" onsubmit="return confirm('Are you sure ?')">
                     @csrf
                     @method('delete')
