    ...
    <section class="content">
      <div class="row">
        ...
        <form  action="{{route('training.update',$data->id)}}" method="POST">
          ...
          <div class="row">
            <div class="col-lg-12">
              <label class="control-label" style="position:relative; top:7px;">training Description:</label>
            </div>
          </div>
          <div style="height:5px;"></div>
          <div class="row">
            <div class="col-lg-12">
              <textarea class="form-control" rows="2" name="trainingDec" id="trainingDec" placeholder="training Description">{!! $data->trainingDec !!}</textarea>
            </div>
          </div>
             <div class="modal-footer">
                    <a class="btn btn-primary" href="{{route('training.index')}}" role="button">Back</a>
