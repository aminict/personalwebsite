    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <div class="row">
            <div class="col-lg-12">
              <textarea class="form-control" rows="2" name="profilesms" id="profilesms" placeholder="contact Description">{!!$data->profilesms!!}</textarea>
            </div>
          </div>
             <div class="modal-footer">
                    <a class="btn btn-primary" href="{{route('contact.index')}}" role="button">Back</a>
