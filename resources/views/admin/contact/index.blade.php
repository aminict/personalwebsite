    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
		  ...
		  <div class="col-sm-3">
              <span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add contact</a></span>
            <!-- Add New -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Add contact</h4></center>
                </div>
            ...
            @if (Session ::has('danger'))
             ...
             @endif
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<input class="form-control" type="text" name="profile" placeholder="profile input">
          ...
          <div class="row">
            <div class="col-lg-4">
              <label class="control-label">Profile Title:</label>
            </div>
            <div class="col-lg-6">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
					...
					<div class="col-lg-12">
						<textarea class="form-control" rows="2" name="profilesms" id="profilesms" placeholder="contact Description"></textarea>
					</div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$row->phone}}</td>
                  <td>{{$row->title}}</td>
                   <td><img src="{{ URL::to('/') }}/postimage/{{ $row->image }}" class="img-thumbnail" width="75" /></td>
                  <td>{!!$row->profilesms!!}</td>
                  <td><a class="btn btn-primary" href="{{route('contact.edit',$row->id)}}" role="button">Edit</a></td>
                  <td>
                  	<form action="{{route('contact.destroy',$row->id)}}" method="POST" onsubmit="return confirm('Are you sure ?')">
                     @csrf
                     @method('delete')
