    ...
    <section class="content">
      <div class="row">
        ...
        <form  action="{{route('project.update',$data->id)}}" method="POST">
          ...
          <div class="row">
            <div class="col-lg-12">
              <label class="control-label" style="position:relative; top:7px;">project Description:</label>
            </div>
          </div>
          <div style="height:5px;"></div>
          <div class="row">
            <div class="col-lg-12">
              <textarea class="form-control" rows="2" name="projectDec" id="projectDec" placeholder="project Description">{!! $data->projectDec !!}</textarea>
            </div>
          </div>
